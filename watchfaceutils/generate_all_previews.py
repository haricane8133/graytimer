...
def generate_all_configured_watchfaces(output_dir="previews",
    ...
    configured_watchfaces = [
        'atat', 'atdp', 'b1', 'bird', 'bird2', 'bugs', 'dog', 'mountain2', 'stormtrooper3_floyd',
        'h', 'krishna', 'macaw', 'mountain1', 'peacock', 'peacock3', 'pegasus',
        'stormtrooper2', 'tom', 'bugs', 'tree', 'walker', 'xwing', 'zebra', 'ben10', 'claw2', 'claw3',
